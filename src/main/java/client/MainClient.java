...
public class MainClient {
    ...
    private static StudentServerGrpc.StudentServerBlockingStub studentServerBlockingStub;
    private static CourseServerGrpc.CourseServerBlockingStub courseServerBlockingStub;

    public MainClient(Channel channel){
        studentServerBlockingStub = StudentServerGrpc.newBlockingStub(channel);
        courseServerBlockingStub = CourseServerGrpc.newBlockingStub(channel);
    }
